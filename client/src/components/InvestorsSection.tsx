    ...
    <section id="investors" className="section" style={{ backgroundColor: "#faf9f7" }}>
      <div className="container mx-auto px-10">
        <div className="max-w-2xl mb-14">
          ...
          <h2 className="section-heading mb-4">Seed Round — $4M at $20M post-money</h2>
          <p className="section-sub">Post-Money SAFE. 32 months runway. Break-even projected Year 4 at 80 customers.</p>
        </div>
          ...
          <div className="card p-8" style={{ borderColor: "#dcd6ce" }}>
            ...
            {submitted ? (
              <div style={{ backgroundColor: "#f0fdf4", border: "1px solid #86efac", borderRadius: "0.875rem", padding: "2rem", textAlign: "center" }}>
                ...
                <p style={{ fontSize: "0.875rem", color: "#047857", marginBottom: "1.25rem" }}>Your email client should have opened with your message pre-filled. We'll get back to you within one business day.</p>
          ...
          <div className="space-y-5">
            <div className="card p-6" style={{ borderColor: "#dcd6ce" }}>
              ...
              <div className="space-y-3">
                {[["Round", "Seed — Post-Money SAFE"], ["Target Raise", "$4,000,000"], ["Post-Money Valuation", "$20,000,000"], ["Equity Dilution", "20%"], ["Cash Runway", "32 months"]].map(([k, v]) => (
