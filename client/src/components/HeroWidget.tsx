...
export function CompanyHeroWidget() {
  const stats = [
    ...
    { value: "144:1", label: "NHI-to-human ratio", color: "#0061d4" },
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
      ...
      <div style={{ ...CARD_STYLE, backgroundColor: "#e8f0fe", border: "1px solid #c2d4f8", padding: "1rem 1.125rem" }}>
        ...
        <div style={{ fontSize: "0.8rem", color: "#1a1a2e", fontWeight: 600, lineHeight: 1.4 }}>The 144:1 Problem: Why AI Agents Are Breaking Identity Governance</div>
