...
const PHASES = [
  {
    ...
    metrics: [
      { label: "Identities mapped", val: "318" },
      { label: "Discovery latency", val: "< 3s" },
      { label: "NHI:Human ratio", val: "144:1" },
    ],
  ...
  },
  {
    ...
    metrics: [
      { label: "Orphans auto-purged", val: "47/wk" },
      { label: "Breach value saved", val: "$1.9M" },
      ...
      <div style={{ paddingTop: 68, minHeight: "100vh" }}>
        <div style={{ padding: "1.25rem 2rem", borderBottom: "1px solid rgba(255,255,255,0.06)", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem" }}>
          ...
          <div style={{ display: "flex", gap: "0.75rem", flexShrink: 0 }}>
            {[{ label: "Identities", value: "318", color: "#60a5fa" }, { label: "Automated", value: "97%", color: "#10b981" }, { label: "Human review", value: "3%", color: "#f59e0b" }].map((m) => (
