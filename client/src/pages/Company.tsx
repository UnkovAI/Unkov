        ...
        <section style={{ borderBottom: "1px solid #e5e7eb", padding: "clamp(2.5rem,5vw,5rem) 0 clamp(2rem,4vw,4rem)", backgroundColor: "#ffffff" }}>
          <div className="container mx-auto px-10" style={{ maxWidth: "900px" }}>
            ...
            <p className="section-sub">
              We're building the AI orchestration engine enterprises need to govern every identity — human and non-human — automatically, at machine speed.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-10" style={{ maxWidth: "900px" }}>
            <div className="grid md:grid-cols-2 gap-5">
              ...
              <div className="card p-8">
                ...
                <p className="text-[#3d4759] leading-relaxed">
                  To become the AI orchestration engine that enterprises rely on to govern every identity — human and non-human — continuously, autonomously, and at machine speed.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-10" style={{ maxWidth: "900px" }}>
            <div className="max-w-3xl">
              ...
              <div className="space-y-5 text-[#3d4759] leading-relaxed" style={{ fontSize: "0.9375rem" }}>
                ...
                <p>With AI agents proliferating across enterprises at ratios as high as 144:1, the traditional human-in-the-loop model breaks down completely. You cannot manually review and approve access for thousands of AI agents. You need autonomous governance — and that's exactly what we built.</p>
                <p>Unkov's AI-native Identity Social Fabric automatically discovers every identity, predicts optimal access patterns with machine learning, and autonomously remediates compliance gaps — all in real time, without human intervention. Unlike Okta (human-only), Entro/Astrix (detection only), or Vanta/Drata (static checklists), Unkov acts as the Permission Gate, builds a cross-sector Bot Reputation Network, roots identity in hardware (TPM/Secure Enclave), and becomes the Compliance System of Record for SEC and HHS auditors.</p>
        ...
        <section className="section border-b border-[#d8dde6]">
          <div className="container mx-auto px-10" style={{ maxWidth: "900px" }}>
            <div className="max-w-xl mb-6">
              ...
              <h2 className="text-2xl font-bold text-[#1d1d1f] mb-3">The AI orchestration engine for enterprise identity governance</h2>
              <p className="text-[#3d4759] leading-relaxed">The end-state is a platform where every identity — human, bot, or AI agent — is discovered, governed, and continuously right-sized automatically. Unkov becomes the Permission Gate every enterprise's agentic workforce depends on. No manual reviews. No orphaned accounts. Four compounding moats: Permission Gate lock-in, Cross-sector network intelligence, Hardware-rooted agent identity, and Compliance gravity. Governance as infrastructure.</p>
            </div>
            <div className="grid md:grid-cols-2 gap-5">
              ...
              <div className="card p-7" style={{ borderColor: "#dcd6ce" }}>
                ...
                <div className="space-y-2">
                  {[
                    ["Today",      "Permission Gate (Micro-Token) — human + NHI + AI agents governed"],
