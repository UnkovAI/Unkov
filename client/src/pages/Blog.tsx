...
const posts = [
  {
    title: "The 144:1 Problem: Why AI Agents Are Breaking Identity Governance",
    excerpt: "In the agentic enterprise, AI agents already outnumber human employees at a 144:1 ratio. Legacy IAM tools weren't built for this reality.",
    body: `The numbers are staggering. By 2026, the average enterprise manages 144 non-human identities for every human employee. Service accounts, API keys, OAuth tokens, CI/CD pipelines, AI copilots — each one a potential attack vector, most of them invisible to legacy IAM tools.\n\nTraditional identity governance was designed for humans. Role-based access control assumes predictable job functions. Access reviews assume someone can read a spreadsheet and make a judgment call. Certification campaigns assume quarterly cadence is fast enough.\n\nNone of those assumptions hold for AI agents. An agent spun up for a specific task can accumulate permissions in minutes. It doesn't follow a job description. It doesn't show up in an HR system. And if it's compromised, it doesn't behave oddly enough to trigger an alert — it just quietly exfiltrates data or escalates privileges.\n\nUnkov was built for this reality. The Identity Social Fabric maps every non-human identity in real time, scores its risk continuously, and remediates automatically when anomalies are detected. No spreadsheets. No quarterly reviews. No human latency in the loop.\n\nThe 144:1 problem isn't coming — it's here. The only question is whether your identity governance can keep up.`,
  ...
  },
  {
    ...
    excerpt: "Service accounts, API keys, OAuth tokens, AI agents — the explosion of NHIs has created an identity attack surface most organizations can't see. And alerting alone won't fix it. You need a Permission Gate.",
        ...
        <section style={{ borderBottom: "1px solid #e5e7eb", padding: "clamp(2rem, 5vw, 5rem) 0 clamp(1.5rem, 4vw, 4rem)", backgroundColor: "#ffffff" }}>
          <div className="container mx-auto px-10" style={{ maxWidth: "900px" }}>
            ...
            <h1 style={{ fontSize: "clamp(2.25rem, 5vw, 3.25rem)", fontWeight: 600, color: "#111827", letterSpacing: "-0.03em", lineHeight: 1.1, marginBottom: "1.25rem" }}>
              Insights on Identity,<br />AI Governance & Security
            </h1>
            <p style={{ fontSize: "1.125rem", color: "#3d4759", lineHeight: 1.7, marginBottom: "2.5rem" }}>
              Thought leadership, case studies, and compliance guides from the team building the next generation of identity orchestration.
            </p>
