...
const coverage = [
  ...
  { outlet: "SC Media",         title: "The Non-Human Identity Crisis: Why 144:1 Agent-to-Human Ratios Demand a New Approach",                  date: "February 20, 2026",url: "https://www.scmagazine.com" },
  { outlet: "Help Net Security", title: "Unkov Launches Identity Social Fabric to Govern AI Agents at Enterprise Scale",                        date: "March 1, 2026",    url: "https://www.helpnetsecurity.com" },
];

const releases = [
  { title: "Unkov Closes $4M Seed Round, Launches AI-Native Identity Orchestration Platform", date: "January 5, 2026", summary: "Unkov today announced the close of a $4M seed financing round and the launch of its AI-native identity orchestration platform. The Identity Social Fabric autonomously discovers, governs, and remediates access for both human and non-human identities at machine speed." },
        ...
        <div className="container mx-auto px-10" style={{ maxWidth: "900px", padding: "clamp(1.5rem, 4vw, 3.5rem) 0 clamp(2rem, 5vw, 5rem)" }}>
          ...
          <div style={{ marginTop: "3.5rem", paddingTop: "3rem", borderTop: "1px solid #e5e7eb" }}>
            ...
            <p style={{ fontSize: "0.9375rem", color: "#374151", lineHeight: 1.75, maxWidth: "640px" }}>
              Unkov is an AI-native identity governance platform built for the agentic enterprise. The Identity Social Fabric continuously discovers, governs, and remediates access for every human, bot, AI agent, and service account — autonomously, at machine speed. Available as a standalone platform or as an intelligence layer on top of Okta, SailPoint, and Azure AD. Founded in 2025, seed-funded, headquartered remotely across the United States.
            </p>
          </div>
