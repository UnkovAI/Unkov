...
const ATTACK_PATHS = [
  {
    ...
    steps: [
      ...
      { id: "agent1", label: "AI Agent: data-proc-07", type: "ai_agent", x: 220, y: 200 },
      { id: "svc1", label: "Svc Acct: etl-runner", type: "service", x: 380, y: 150 },
    ...
    blast_radius: "$4.2M",
    remediation: "Kill-switch on data-proc-07 + revoke etl-runner → db-admin link",
  },
  {
    id: 2,
    severity: "high",
