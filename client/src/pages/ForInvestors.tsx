...
const terms = [
  ...
  ["Equity Dilution",      "20%"],
  ["Cash Runway",          "32 months"],
];

const funds = [
  { label: "Talent",         pct: 70, amount: "$2,800,000", desc: "5 AI/ML and data engineers at $180K fully loaded cost" },
  { label: "Infrastructure", pct: 20, amount: "$800,000",   desc: "Graph infrastructure, ML inference compute, and AWS cloud operations" },
  { label: "Go-to-Market",   pct: 10, amount: "$400,000",   desc: "High-intent lead generation for BFSI and Healthcare verticals" },
];
...
const buyers = [
  ...
  { icon: DollarSign,  role: "CFO",                      pain: "Breach cost exposure, compliance spend",        hook: "$1.9M average savings per incident avoided"         },
...
const competitive = [
  ...
  { cap: "Permission model", unkov: "Policy-as-Code Micro-Token Gate", legacy: "Static role assignments"            },
...
const swot = [
  ...
  { type: "Opportunities", color: "#0061d4", bg: "#eff6ff", border: "#bfdbfe", items: [
    ...
    "144:1 NHI-to-human ratio creates an ungoverned attack surface legacy tools cannot address",
          ...
          <div className="container mx-auto px-10">
            <div className="max-w-3xl">
              ...
              <p className="section-sub mb-8">
                AI-native identity orchestration for the agentic enterprise. $4M seed at $20M post-money. 32-month runway to $500K ARR and Series A.
              </p>
        ...
        <section className="section border-b border-[#d8dde6]" style={{ backgroundColor: "#f0ece6" }}>
          <div className="container mx-auto px-10">
            <div className="max-w-xl mb-6">
              ...
              <h2 className="text-2xl font-bold text-[#1d1d1f] mb-3">Two compounding crises legacy IAM cannot solve</h2>
              <p className="text-sm text-[#3d4759] leading-relaxed">In 2026, AI agents outnumber human employees at a 144:1 ratio. Legacy tools were built for quarterly review cycles and human-only directories. That world no longer exists.</p>
            </div>
        ...
        <section className="section border-b border-[#d8dde6]">
          <div className="container mx-auto px-10">
            ...
            <div className="grid md:grid-cols-3 gap-5">
              {[
                { stat: "144:1",   label: "NHI-to-human ratio in agent-heavy enterprises (2026)", color: "#0061d4" },
                ...
                { stat: "$1.9M",   label: "Average savings per incident with AI-driven security",  color: "#059669" },
        ...
        <section className="section border-b border-[#d8dde6]" style={{ backgroundColor: "#f6f8fa" }}>
          <div className="container mx-auto px-10">
            <div className="max-w-xl mb-6">
              ...
              <h2 className="text-2xl font-bold text-[#1d1d1f] mb-3">The 4-Phase Autonomous Governance Loop</h2>
              <p className="text-sm text-[#3d4759] leading-relaxed">Unkov replaces 120-hour manual processes with a continuous, self-healing governance loop — operating as a standalone platform or as an intelligence overlay on Okta, SailPoint, or Azure AD with zero rip-and-replace.</p>
            </div>
            <div className="grid md:grid-cols-2 gap-5 mb-8">
              {[
                { icon: Brain,     n: "01", color: "#0061d4", title: "Discover — Identity Social Fabric",  desc: "Zero-touch API scan builds a live AI-native relationship graph — mapping every human, bot, service account, and AI agent plus every resource they touch. Live Identity Drift dashboard in under 30 minutes.", access: "Read-Only / Auditor" },
              ...
              {[
                {
                  ...
                  sub: "Action-Interference Lock-In",
                  body: "Every AI agent must request a Micro-Token from Unkov before it can move money in Fintech or access a patient record in Healthcare. Once embedded in automated workflows, removing Unkov means the entire AI workforce stops operating.",
        ...
        <section className="section border-b border-[#d8dde6]">
          <div className="container mx-auto px-10">
            ...
            <div className="grid md:grid-cols-3 gap-4 max-w-3xl">
              {[["82%", "Target gross margin"], ["$1.9M", "Avg. savings per incident"], ["3–5×", "Target ROI by Month 24"]].map(([v, l]) => (
